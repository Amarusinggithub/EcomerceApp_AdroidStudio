...
public class MainActivity extends AppCompatActivity  {
    ...
    public static List<Product> getProductsData(String id) {
        ...
        if (PHONES.equals(id)) {
            productsArrayList.add(new Product(R.drawable.s24plus,"SAMSUNG Galaxy S24+","$969.99 ","SAMSUNG Galaxy S24+ Plus Cell Phone, 512GB AI Smartphone, Unlocked Android, 50MP Camera, Fastest Processor, Long Battery Life, US Version, 2024, Onyx Black", PHONES));
            ...
            productsArrayList.add(new Product(R.drawable.a54_samsung,"SAMSUNG Galaxy A54","$449.99","SAMSUNG Galaxy A54 5G A Series Cell Phone, Unlocked Android Smartphone, 128GB, 6.4” Fluid Display Screen, Pro Grade Camera, Long Battery Life, Refined Design, US Version, 2023, Awesome Black", PHONES));
            productsArrayList.add(new Product(R.drawable.redmi_note13_pro,"Redmi Note 13 PRO","$310.96","Xiaomi Redmi Note 13 PRO 5G + 4G LTE (256GB + 8GB) 6.67, 200MP Triple (Tmobile Mint Tello & Global) Global Bands Unlocked + (Fast Car Dual Charger Bundle) (Midnight Black (Global ROM))", PHONES));
            ...
            productsArrayList.add(new Product(R.drawable.iphone_13,"IPhone 13","$388.10","The iPhone 13 features a 6.1-inch (155 mm) display with Super Retina XDR OLED technology at a resolution of 2532×1170 pixels and a pixel density of about 460 PPI with a refresh rate of 60 Hz and Dolby Vision HDR.", PHONES));
            productsArrayList.add(new Product(R.drawable.iphone_13_pro,"IPhone 13 Pro","$494.75","iPhone 13 Pro, 256GB, Sierra Blue - Unlocked (Renewed Premium), comes with charger, Mfi cable and SIM Pin ejector", PHONES));
            productsArrayList.add(new Product(R.drawable.s10_plus,"SAMSUNG Galaxy S10+","$265.72","SAMSUNG Galaxy S10+ Plus (128GB, 8GB) 6.4\" AMOLED, Snapdragon 855, IP68 Water Resistant, Global 4G LTE (GSM + CDMA) Unlocked (AT&T, Verizon, T-Mobile, Metro) G975U (Prism Blue)", PHONES));
            productsArrayList.add(new Product(R.drawable.iphone_15_pro_max,"IPhone 15 Pro Max","$1,529.97","iPhone 15 Pro Max has a 6.7-inch all-screen Super Retina XDR display with the Dynamic Island. The back is textured matte glass, and there is a contoured-edge titanium band around the frame.", PHONES));
            productsArrayList.add(new Product(R.drawable.iphone_14_pro_max,"IPhone 14 Pro Max","$799.90","6.7-inch Super Retina XDR display featuring Always-On & ProMotion.", PHONES));
            ...
            productsArrayList.add(new Product(R.drawable.leveni_legion_slim_7i,"Lenovo Legion 7i","$1,499.99","Lenovo Legion Slim 7i Gaming & Entertainment Laptop (Intel i9-13900H 14-Core, 16GB DDR5 5200MHz RAM, 1TB SSD, GeForce RTX 4070, 16.0\" Win 11 Home) with Microsoft 365 Personal, Dockztorm Hub", LAPTOP));
            productsArrayList.add(new Product(R.drawable.asus_rog_strix_16,"ROG Strix Scar","$2,899.99","ASUS ROG Strix Scar 16 (2024) Gaming Laptop, 16” Nebula HDR 16:10 QHD 240Hz/3ms, 1100 nits, Mini LED Display, GeForce RTX 4080, Intel Core i9-14900HX, 32GB DDR5, 1TB SSD, Windows 11 Pro, G634JZR-XS96", LAPTOP));
            productsArrayList.add(new Product(R.drawable.asus_tuf_a17,"ASUS TUF A17 Gaming ","$1,859.00","ASUS TUF A17 Gaming Laptop - 17.3\" FHD Display, AMD Ryzen 9-7940HS (8-core), NVIDIA GeForce RTX 4070, 32GB DDR5, 1TB SSD, Backlit Keyboard, Wi-Fi 6, Windows 11 Home, with Laptop Stand", LAPTOP));
            productsArrayList.add(new Product(R.drawable.asus_tuff_a16,"ASUS TUF A16","$979.00","ASUS TUF Gaming A16 Laptop 16.0\" 165 Hz FHD+WVA (8-Core AMD Ryzen 7 7735HS, 16GB DDR5, 1TB PCIe SSD, AMD Radeon RX 7600S 8GB, Backlit KYB, WiFi 6, Win11 Home) with Dockztorm Hub", LAPTOP));
            productsArrayList.add(new Product(R.drawable.acer_nitro_17,"Acer Nitro Gaming","$983.48","Acer Nitro 17 Gaming Laptop AMD Ryzen 7 7840HS Octa-Core CPU 17.3\" FHD 165Hz IPS Display NVIDIA GeForce RTX 4050 16GB DDR5 1TB SSD Wi-Fi 6E RGB Backlit KB AN17-41-R6L9", LAPTOP));
            productsArrayList.add(new Product(R.drawable.msi_sword_15,"MSI Sword Gaming"," $1,199.99","MSI Newest Sword 15 Gaming Laptop, 15.6\" FHD 144Hz IPS-Type Display, NVIDIA GeForce RTX 4060, Intel Core i7-12650H, 32GB DDR4, 1TB PCIe SSD, Wi-Fi 6, Windows 11 Home, Backlit Keyboard, White/OLY", LAPTOP));
            productsArrayList.add(new Product(R.drawable.msi_raider_laptop,"MSI Raider GE76","$1,391.03","MSI Raider GE76 Gaming Laptop: Intel Core i9-12900H, GeForce RTX 3060, 17.3\" 144Hz FHD Display,16GB DDR5, 1TB NVMe SSD, Thunderbolt 4, Cooler Boost 5, Win 11 Home: Titanium Blue 12UE-871", LAPTOP));
            productsArrayList.add(new Product(R.drawable.gigabyte_laptop,"GIGABYTE - G6","$999.00","GIGABYTE - G6 (2024) Gaming Laptop - 165Hz 1920x1200 WUXGA - NVIDIA GeForce RTX 4050 - Intel i7-13620H - 1TB SSD with 16GB DDR5 RAM - Win11 Home+ (G6 MF-H2US854KH)", LAPTOP));
            productsArrayList.add(new Product(R.drawable.razor_laptop,"Razer Blade 16","$4,699.99","Razer Blade 16 (2024) Gaming Laptop: 16” Mini LED Dual Mode 4K UHD+ 120Hz / FHD+ 240Hz – NVIDIA GeForce RTX 4090 – Intel Core i9-14900HX - 64GB DDR5 RAM  - 4TB M.2 SSD – Chroma RGB – Black", LAPTOP));
            productsArrayList.add(new Product(R.drawable.hp_xictus_laptop,"HP Victus 15","$578.00","HP Victus 15 Gaming Laptop 15.6\" FHD IPS 144Hz AMD 7000 Ryzen 5 7535HS (Beats i7-11800H) GeForce RTX 2050 4GB Graphic Backlit USB-C B&O Win11 Black + HDMI Cable (8GB RAM | 512GB PCIe SSD)", LAPTOP));
            productsArrayList.add(new Product(R.drawable.msi_pulse,"MSI Pulse 17 ","$1,899.00","MSI Pulse 17 Gaming Laptop: 13th Gen i9, 17” 240Hz QHD Display, NVIDIA GeForce RTX 4070, 32GB DDR5, 1TB NVMe SSD, Cooler Boost 5, Win11 Home: Black B13VGK-887US", LAPTOP));
            ...
            productsArrayList.add(new Product(R.drawable.xbox_series_s,"Xbox Series S","$299.00","2021 Microsoft Xbox Series S 512GB Game All-Digital Console, One Xbox Wireless Controller, 1440p Gaming Resolution, 4K Streaming, 3D Sound, WiFi, White", CONSOLES));
            productsArrayList.add(new Product(R.drawable.ps4_slim,"PlayStation 4 Slim","$223.99","Edition:Slim 1TB The all new lighter and slimmer PlayStation4 system has a 1TB hard drive for all of the greatest games, TV, music and more. Incredible Games You've come to the right place.", CONSOLES));
            ...
            productsArrayList.add(new Product(R.drawable.ps4_pro,"PlayStation 4 Pro","$244.00","Sony PlayStation 4 Pro w/ Accessories, 1TB HDD, CUH-7215B - Jet Black.Enhanced games - PS4 Pro games burst into life with intensely sharp graphics, stunningly vibrant colours, textures and environments and smoother, more stable performance", CONSOLES));
            ...
            productsArrayList.add(new Product(R.drawable.samsung_32_qled_tv,"SAMSUNG 32-Inch 4K","$447.99","SAMSUNG 32-Inch Class QLED 4K Q60C Series Quantum HDR, Dual LED, Object Tracking Sound Lite, Q-Symphony, Motion Xcelerator, Gaming Hub, Smart TV with Alexa Built-in (QN32Q60C, 2023 Model),Titan Gray", APPLIANCES));
            ...
            productsArrayList.add(new Product(R.drawable.smart_fan,"Smart Tower Fan"," $63.99","Dreo Smart Tower Fan for Bedroom, Standing Fans for Indoors, 90° Oscillating, Quiet 26ft/s Velocity Floor Fan with Remote, 5 Speeds, 8H Timer, Voice Control Bladeless Room Fan, Works with Alexa", APPLIANCES));
            productsArrayList.add(new Product(R.drawable.air_purifier,"Air Purifier","$189.99","LEVOIT Air Purifiers for Home Large Room Up to 1980 Ft² in 1 Hr With Air Quality Monitor, Smart WiFi and Auto Mode, 3-in-1 Filter Captures Pet Allergies, Smoke, Dust, Core 400S/Core 400S-P, White", APPLIANCES));
            productsArrayList.add(new Product(R.drawable.thermostat,"Thermostat ","$199.98","Google Nest Learning Thermostat - Programmable Smart Thermostat for Home - 3rd Generation Nest Thermostat - Works with Alexa - Stainless Steel", APPLIANCES));
            productsArrayList.add(new Product(R.drawable.roomba, "Robot Vacuum","$219.99","iRobot Roomba 694 Robot Vacuum-Wi-Fi Connectivity, Personalized Cleaning Recommendations, Works with Alexa, Good for Pet Hair, Carpets, Hard Floors, Self-Charging, Roomba 694", APPLIANCES));
            productsArrayList.add(new Product(R.drawable.amazon_echo,"Amazon Echo","$59.99","Amazon Echo Dot (5th Gen) with clock | Compact smart speaker with Alexa and enhanced LED display for at-a-glance clock, timers, weather, and more | Cloud Blue", APPLIANCES));
            productsArrayList.add(new Product(R.drawable.soundbar,"TV Speaker"," $229.00","Bose TV Speaker - Soundbar for TV with Bluetooth and HDMI-ARC Connectivity, Black, Includes Remote Control", APPLIANCES));
            productsArrayList.add(new Product(R.drawable.vaccume_cleaner,"Dyson Vacuum"," $299.00","Ball technology. Navigate around obstacles with a simple turn of the wrist. For easy, precise maneuvering around your home.", APPLIANCES));
            productsArrayList.add(new Product(R.drawable.blender,"Ninja Kitchen System"," $159.95","Ninja BL770 Mega Kitchen System, 1500W, 4 Functions for Smoothies, Processing, Dough, Drinks & More, with 72-oz.* Blender Pitcher, 64-oz. Processor Bowl, (2) 16-oz. To-Go Cups & (2) Lids, Black", APPLIANCES));
            productsArrayList.add(new Product(R.drawable.kettle,"Electric Kettle","$69.99","COSORI Electric Gooseneck Kettle with 5 Temperature Control Presets, Pour Over Kettle for Coffee & Tea, Hot Water Boiler, 100% Stainless Steel Inner Lid & Bottom, 1200W/0.8L", APPLIANCES));
            productsArrayList.add(new Product(R.drawable.lamp,"LED Lamp","$115.99","LED Floor Lamp, Height Adjustable Floor Lamps for Living Room, Super Bright Standing Lamp with Timer, Adjustable Colors & Brightness Floor lamp for Bedroom with Remote & Touch Control, Black", APPLIANCES));
        }else if (POPULAR_PRODUCTS.equals(id)) {
            productsArrayList.add(new Product(R.drawable.leveni_legion_slim_7i,"Lenovo Legion 7i ","$1,499.99","Lenovo Legion Slim 7i Gaming & Entertainment Laptop (Intel i9-13900H 14-Core, 16GB DDR5 5200MHz RAM, 1TB SSD, GeForce RTX 4070, 16.0\" Win 11 Home) with Microsoft 365 Personal, Dockztorm Hub", POPULAR_PRODUCTS));
            productsArrayList.add(new Product(R.drawable.asus_rog_strix_16,"ROG Strix Scar","$2,899.99","ASUS ROG Strix Scar 16 (2024) Gaming Laptop, 16” Nebula HDR 16:10 QHD 240Hz/3ms, 1100 nits, Mini LED Display, GeForce RTX 4080, Intel Core i9-14900HX, 32GB DDR5, 1TB SSD, Windows 11 Pro, G634JZR-XS96", POPULAR_PRODUCTS));
            productsArrayList.add(new Product(R.drawable.asus_tuf_a17,"ASUS TUF A17 Gaming","$1,859.00","ASUS TUF A17 Gaming Laptop - 17.3\" FHD Display, AMD Ryzen 9-7940HS (8-core), NVIDIA GeForce RTX 4070, 32GB DDR5, 1TB SSD, Backlit Keyboard, Wi-Fi 6, Windows 11 Home, with Laptop Stand", POPULAR_PRODUCTS));
            productsArrayList.add(new Product(R.drawable.asus_tuff_a16,"ASUS TUF Gaming A16","$979.00","ASUS TUF Gaming A16 Laptop 16.0\" 165 Hz FHD+WVA (8-Core AMD Ryzen 7 7735HS, 16GB DDR5, 1TB PCIe SSD, AMD Radeon RX 7600S 8GB, Backlit KYB, WiFi 6, Win11 Home) with Dockztorm Hub", POPULAR_PRODUCTS));
            productsArrayList.add(new Product(R.drawable.samsung_32_qled_tv,"SAMSUNG 32-Inch 4K ","$447.99","SAMSUNG 32-Inch Class QLED 4K Q60C Series Quantum HDR, Dual LED, Object Tracking Sound Lite, Q-Symphony, Motion Xcelerator, Gaming Hub, Smart TV with Alexa Built-in (QN32Q60C, 2023 Model),Titan Gray", POPULAR_PRODUCTS));
            productsArrayList.add(new Product(R.drawable.air_fryer,"Air Fryer","$89.95","Instant Vortex Plus 6QT ClearCook Air Fryer, Clear Windows, Custom Program Options, 6-in-1 Functions, Crisps, Broils, Roasts, Dehydrates, Bakes, Reheats, from the Makers of Instant Pot, Black", POPULAR_PRODUCTS));
            ...
            productsArrayList.add(new Product(R.drawable.xbox_series_s,"Xbox Series S","$299.00","2021 Microsoft Xbox Series S 512GB Game All-Digital Console, One Xbox Wireless Controller, 1440p Gaming Resolution, 4K Streaming, 3D Sound, WiFi, White", POPULAR_PRODUCTS));
            productsArrayList.add(new Product(R.drawable.ps4_slim,"PlayStation 4 Slim","$223.99","Edition:Slim 1TB The all new lighter and slimmer PlayStation4 system has a 1TB hard drive for all of the greatest games, TV, music and more. Incredible Games You've come to the right place.", POPULAR_PRODUCTS));
